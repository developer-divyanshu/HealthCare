...
--
-- Table structure for table `patient_more_info`
--

CREATE TABLE `patient_more_info` (
  `p_id` int(9) NOT NULL,
  `dob` date NOT NULL,
...
--
-- Indexes for table `patient_more_info`
--
ALTER TABLE `patient_more_info`
...
--
-- AUTO_INCREMENT for table `patient_more_info`
--
ALTER TABLE `patient_more_info`
