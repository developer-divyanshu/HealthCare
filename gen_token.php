<?php
    ...
    $sql_for_checking_info="select * from patient_more_info where login_id='$p_id'";
    ...
    if (isset($_POST['token'])){
        $create_live_token="CREATE TABLE if NOT EXISTS live_token (token_no int(9) NOT null AUTO_INCREMENT, is_started int(1) not null DEFAULT 0, p_id int(9) not null, PRIMARY KEY(token_no), foreign key(p_id) references patient_more_info(p_id))";
