<?php 
    ...
    $sql_for_taking_token_no = "SELECT f_name, l_name, email,gender, photo_path, area, age, dob, phone,live_token.p_id, token_no,(SELECT token_no FROM live_token order by token_no desc limit 1) as Total from live_token, patient_more_info, patient_login WHERE live_token.p_id=patient_more_info.p_id and patient_more_info.login_id=patient_login.pno ORDER by live_token.token_no LIMIT 1";
